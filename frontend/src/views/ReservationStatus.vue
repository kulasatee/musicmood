<template>
  <div style="background-color: #131022; height: 100vh">
    <div class="container pt-5" style="background-color: #131022">
      ...
      <div class="row mt-3">
        <ul
          class="list-group list-group-horizontal res-list-group py-3 text-start fw-light align-items-center" :id="reservation.reserve_id" v-for="reservation in filteredReservation" :key="reservation.reservation_id" @click="showReservationModal(reservation)">
          ...
          <div class="modal-content px-2 pb-3">
            <div class="modal-header align-contents-between d-flex">
              <div class="d-flex flex-column align-items-start">
                <span class="modal-title fs-3">{{selected_reservation.room_name}}</span><span class="fw-light">Created Date: {{ inform_datetime_modal }}</span>
              </div>
            ...
            <div class="modal-body text-start">
              ...
              <div class="mt-2">
                <span>Reserve Date:</span><span class="fw-light ms-3">{{ reserve_datetime_modal }}</span>
              </div>
              ...
              <div v-if="selected_reservation.reserve_status == 'approved'" class="mt-2" style="color: #6366f1">
                <span><i class="bi bi-info-circle"></i></span><span class="fw-light ms-2">หลังใช้บริการห้องแล้ว สามารถรีวิวห้องได้<span @click="goToReview()" style="color: #6366f1"><span class="ms-1 text-decoration-underline fw-normal" style="cursor: pointer">ที่นี่</span></span></span>
              </div>
            </div>
          </div>
        </div>
